...
def test_example(page):
    ...
    page.get_by_role("button", name="icon Project templates").click()
    expect(page.get_by_text("Preview template Use template")).to_be_visible()
    page.get_by_text("Use template").click()
